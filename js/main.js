    ...
    var touch = {
        ...
        Binding: function() {
            ...
            if (window.attachEvent) {
                ...
                jPages.get(0).attachEvent("ontouchstart", function(e) { _this.start(e); });
                jPages.get(0).attachEvent("ontouchmove", function(e) { _this.move(e); });
                jPages.get(0).attachEvent("ontouchend", function(e) { _this.end(e); });
                jPages.get(0).attachEvent("onmousedown", function(e) {_this.start(e);});
                jPages.get(0).attachEvent("onmousemove", function(e) {_this.move(e);});
                jPages.get(0).attachEvent("onmouseup", function(e) {_this.end(e);});
            } else if (window.addEventListener) {
                jPages.get(0).addEventListener("touchstart", function(e) { _this.start(e); }, false);
                jPages.get(0).addEventListener("touchmove", function(e) { _this.move(e); }, false);
                jPages.get(0).addEventListener("touchend", function(e) { _this.end(e); }, false);
                jPages.get(0).addEventListener("mousedown", function(e) {_this.start(e);}, false);
                jPages.get(0).addEventListener("mousemove", function(e) {_this.move(e);}, false);
                jPages.get(0).addEventListener("mouseup", function(e) {_this.end(e);}, false);
            }
